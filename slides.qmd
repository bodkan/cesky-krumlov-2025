...
::: aside
See an amazing paper by [Ralph _et al._ (2020)](https://academic.oup.com/genetics/article/215/3/779/5930459) for more detail.
:::
...
you can use `ts_mutate()` like this.</h4>
...
3. We can also get a per-population list of individuals:
