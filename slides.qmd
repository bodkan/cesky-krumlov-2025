...
-   a lot of code for very complex simulations,
...
::: {.fragment}
<center><br>As a recap, let's look at _msprime_ and SLiM a little bit...</center>
:::
...
-   You should know Python fairly well to build complex models (what's
"complex" is of course debatable!)
:::
...
**The exercise materials have a note on opening the activity
