...
You can write your _slendr_ code however you like, but I recommed using RStudio, for convenience.
...
<center><h2>All _slendr_ statistics accept this as their second (and further) arguments.</h2></center>

<br>

<center>This is modelled after the `sample_sets=` argument of the respective [_tskit_ Python methods](https://tskit.dev/tskit/docs/stable/python-api.html#statistics) (except that you use "symbolic names" of individuals, not tree-sequence node numbers).</center>
