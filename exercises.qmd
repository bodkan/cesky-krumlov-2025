...
simulate_afs <- function(Ne) {
  <... population model code: population(), compile_model(), ts <- msprime(), etc ...>
  <... get names of a subset of 10 samples from a tree sequence ...>
  <... compute AFS with ts_afs() on 10 samples ...>
