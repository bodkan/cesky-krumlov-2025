...
course"** which we started our activity session with. Ideally, they should cover pretty
...
**Hint:** Start script `exercise1.R` script in your RStudio session using this "template". Then build a sequence of appropriate `population()` calls using
