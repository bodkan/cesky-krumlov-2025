...
**Note:** If you're using the RStudio browser-based cloud instance, you don't
have to do anything! Just open the RStudio session in your browser and
...
(maybe after the workshop is over) just follow the couple of steps right
below.**
...
a statistic to a concrete tangible result in just a few lines of R code.
