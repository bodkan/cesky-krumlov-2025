...
If you find yourself [*totally lost*](https://scryfall.com/card/gtc/54/totally-lost), don't hesitate to read my solution scripts from the get go, trying to understand what's going on in them, and executing them line by line in your RStudio session.
