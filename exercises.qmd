...
As you're working on the exercises below, some reference materials will be 
useful. In general, all of the exercises are based around my
popgen simulation R package [_slendr_](https://slendr.net), which is why
I recommed consulting the following reference materials:
...
**If you're using the RStudio browser-based cloud instance, you don't
...
long as you are able to visualize figures.
...
going through with everyone) -- those should provide at least some
entertainment for you while the rest of us are catching up. If you're
_really_ far ahead, just continue to following exercises without waiting for
the rest of us. You can also try to design your own models from scratch, such
as models relevant for your model organism and popgen statistics relevant for
your own work.
...
Your figure should roughly correspond to my handdrawn doodle above.
