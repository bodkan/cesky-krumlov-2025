...
## Part 6: Tree-sequence simplification and EIGENSTRAT conversion
...
## Part 7: PCA visualization on subsets of individuals

**TODO**: Try to replicate some of the Elhaik results with EUR/ASIAN/AFR/Indian patterns.
Would this work with the current simple model? If not, expand it a little, but still
maintain the simplicity of the Parts 1-5.