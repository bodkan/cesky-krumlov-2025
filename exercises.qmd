...
[`ts_diversity()`](https://www.slendr.net/reference/ts_diversity.html#ref-examples), as simulated in your tree-sequence result `ts`.
...
each individual separately using the same function `ts_diversity()`** (which, in this setting, gives you effectively the heterozygosity for each individual).
