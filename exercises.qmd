...
**Program the following toy model of human demographic history in _slendr_.**
...
Program a _slendr_ model which captures the most important features of the model organism that you're study or that you're more interested in! You will have a chance to work with it in future exercises.
